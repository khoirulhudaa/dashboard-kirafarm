...
// Helper untuk mengubah slug route menjadi title yang rapi
const formatPageTitle = (pathname: string): string => {
  // Hapus leading slash dan trailing slash
  let cleanPath = pathname.replace(/^\/|\/$/g, "");

  // Jika path kosong (home), beri title default
  if (cleanPath === "") return "Halaman Utama";

  // Ganti dash (-) dengan spasi, lalu capitalize setiap kata
  return cleanPath
    .split("-")
